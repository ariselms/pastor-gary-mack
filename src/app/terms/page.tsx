...
import { TermsPageContent } from "@/components/pages-content/TermsPageContent";
...
export async function generateMetadata(): Promise<any> {
  ...
  return {
		title: isEnglish
			? "Pastor Gary Mack - Ministerio Los Rescatados Rescatando - Términos y Condiciones"
			: "Pastor Gary Mack - Los Rescatados Rescatando Ministry - Terms and Conditions",
		...
		openGraph: {
			...
			url: "https://pastorgarymack.com/terms",
