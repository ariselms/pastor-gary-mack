...
export async function generateMetadata(): Promise<any> {
  ...
  return {
		title: isEnglish
			? "Pastor Gary Mack - Ministerio Los Rescatados Rescatando - Contáctanos"
			: "Pastor Gary Mack - Los Rescatados Rescatando Ministry - Contáct Us",
		...
		openGraph: {
			...
			url: "https://pastorgarymack.com/contact",
