...
export function AboutPageContent() {
	...
	const aboutContent = {
		...
		bioP2: isEnglish
			? 'His radical transformation occurred during a massive police raid from which escape seemed humanly impossible. After calling out to Father God and pledging his service, he was miraculously guided to safety—an event that marked the end of his criminal life and the beginning of his ministry. Together with his wife, he paid a high price for his faith, enduring homelessness and sleeping exposed to the elements in a churchyard. It was in this "furnace of affliction" that he forged what he calls the "Mongoose Mentality": an unwavering determination to confront the enemy and transform the poison of the past into strength.'
			: 'Su transformación radical ocurrió durante una redada policial masiva de la cual escapar parecía humanamente imposible. Tras clamar a el Padre y prometerle su servicio, fue guiado milagrosamente hacia la seguridad—un evento que marcó el fin de su vida delictiva y el comienzo de su ministerio. Junto a su esposa, pagó un alto precio por su fe, soportando la indigencia y durmiendo a la intemperie en el patio de una iglesia. Fue en ese "horno de aflicción" donde forjó lo que él llama la "Mentalidad de Mangosta": una determinación inquebrantable para enfrentar al enemigo y transformar el veneno del pasado en fortaleza.',
		bioP3: isEnglish
			? 'Gary Mack stands as a living testament to the restorative power of the Gospel. As the founder and pastor of the ministry "Los Rescatados Rescatando" (The Rescued Rescuing) in the Los Ríos sector of the Dominican Republic, he dedicated over a decade of his life to reaching the marginalized, taking the Word of Father God into prisons, hospitals, and drug distribution points. His ministry has witnessed the conversion of thousands of inmates and criminals who surrendered their weapons in exchange for a new life. Through his books and preaching, he teaches that victory is conquered through prayer and faith, demonstrating that Father God can turn any history of pain into a glorious purpose.'
			: 'Gary Mack permanece como un testimonio vivo del poder restaurador del Evangelio. Como fundador y pastor del ministerio "Los Rescatados Rescatando" en el sector Los Ríos de la República Dominicana, dedicó más de una década de su vida a alcanzar a los marginados, llevando la Palabra de el Padre a cárceles, hospitales y puntos de droga. Su ministerio ha sido testigo de la conversión de miles de reclusos y delincuentes que entregaron sus armas a cambio de una nueva vida. A través de sus libros y prédicas, enseña que la victoria se conquista con oración y fe, demostrando que el Padre puede convertir cualquier historia de dolor en un propósito glorioso.',
		bioP4: isEnglish
			? "Today, Gary Mack continues his assignment in the Kingdom of Almighty Father God alongside his wife and children in the State of Maryland. He currently serves as the Senior Pastor of 'Nación de Fe' and its community of believers."
			: "Hoy, Gary Mack continúa su asignación en el Reino de el Padre Todopoderoso junto a su esposa e hijos en el estado de Maryland. Actualmente sirve como Pastor Principal de la iglesia 'Nación de Fe' y su comunidad de creyentes."
	};
