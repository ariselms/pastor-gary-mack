...
export default function MentalidadDeMangostaBook() {
	...
	const chapters = [
		...
		{ id: "capitulo-2", title: "Capítulo 2: El Corazón de el Padre" },
				...
				<article className="space-y-16">
					...
					<section
						...
						<div className="space-y-6 text-lg text-slate-200">
							<p>
								Doy gracias a el Padre Todopoderoso por permitirme escribir este
							...
							<p>
								...
								demostrarles que el Padre cumple su propósito en mi vida.
							</p>
							<p>
					...
					<section id="introduccion" className="scroll-mt-24">
						...
						<div className="space-y-6 text-lg text-slate-200">
							...
							<h3 className="text-2xl font-bold text-yellow-100 mt-8 mb-4">
								Un pasado transformado por el Padre
							</h3>
							<p>
								...
								cicatrices intenten definirnos, el Padre tiene el poder de
							...
							<p>
								...
								e intimidad el Padre. Es a través de la oración que rompemos las
								cadenas que nos atan al pasado y avanzamos con pasos firmes
								hacia nuestro propósito. Sin una conexión profunda el Padre, es
							...
							<p>
								...
								el destino que el Padre ha diseñado para mí. Quiero que sepas que
							...
							<p>
								...
								con la fuerza que el Padre nos da.
							</p>
							<p>
								...
								orar, a renovar mi mente y a poner mi confianza en el Padre, todo
					...
					<section
						...
						<div className="space-y-6 text-lg text-slate-200">
							...
							<p>
								...
								las circunstancias que enfrenté, el propósito de el Padre siempre
							...
							<p>
								...
								buscar a el Padre. Sin embargo, a pesar de eso, no tuve una infancia
							...
							<p>
								...
								en medio de la angustia y el dolor, el Padre está presente. Puede
							...
							<p>
								...
								mi abuela, y estoy agradecido a el Padre por haber puesto a estas
								personas en mi camino durante ese tiempo de dificultad. En medio
								de todo, el Padre los usó para mostrar su fidelidad. Ellos me
							...
							<p>
								...
								plan de el Padre. Y, en realidad, es lógico pensar así. Sin embargo,
								es importante comprender la naturaleza milagrosa de la palabra
								de el Padre. Cada experiencia que vivimos, aunque no sea
								directamente provocada por Él, puede ser utilizada por el Padre para
								mostrar su gloria a través de nosotros. A menudo, en estos
								momentos difíciles, el Padre se manifiesta de maneras inesperadas y
								poderosas.
							</p>
							...
							<p>
								...
								propósito en el plan de el Padre. Hoy en día, mi madre le sirve a
								Cristo, y nuestra relación se ha transformado: ella me ama y yo
								la amo. Mi hermano más pequeño también es cristiano, y ahora
								solo falta mi otro hermano. Sin embargo, confío en que el Padre está
								...
								está cumpliendo y cómo el Padre se ha glorificado en nuestras vidas.
							</p>
							<p>
								Por tanto, no tengo la menor duda de que todo lo que sufrí,
								aunque no lo comprendía en ese momento, de alguna manera el Padre lo
								usó en su plan divino a mi favor. Lo que el enemigo pensó que me
								destruiría, el Padre lo revirtió y lo utilizó para traer bendición a
								mi vida.
							</p>
							<p>
								...
								única, de mantener una comunicación constante el Padre. No
								puedes recibir la revelación del propósito de el Padre para tu vida
								sin oración.
							</p>
							<p>
								Busca siempre escuchar a el Padre y hablarle; conviértelo en tu
								amigo. Esto te asegurará la victoria en la vida cristiana. Deja
								el pasado atrás y enfócate en el glorioso futuro que el Padre tiene
								reservado para ti.
							</p>
						</div>
					</section>
					...
					<section
						...
						<div className="space-y-6 text-lg text-slate-200">
							<p>
								A veces pensamos que el Padre solo bendice y ayuda a aquellos que le
							...
							<p>
								...
								aquellos que todavía no lo conocen o que se han apartado. el Padre,
							...
							<p>
								...
								pidiéndole a el Padre que la DNCD no me encontrara. Pero un día,
							...
							<p>
								...
								cuando estaba en apuros, yo clamaba a el Padre. El tiempo parecía
								haberse detenido. Miré al cielo, hablé el Padre en voz alta y
								dije:
							</p>
							...
							<p>
								Yo sabía que ese relámpago había sido una señal de parte de el Padre
							...
							<p className="pl-4 font-bold text-yellow-300">
								—No te voltees, que te están mirando, vámonos el Padre.
							</p>
							<p>
								En ese momento levanté mis manos al cielo y empecé a adorar a
								el Padre mientras caminaba, hasta llegar a mi casa. Bajé al niño
							...
							<p>
								...
								ese día escuché esa voz y supe que era la voz de el Padre. Fuerte,
								clara e inconfundible.
							</p>

							<h3 className="text-xl font-bold text-yellow-100 mt-8 mb-4">
								¿Escucha el Padre al pecador?
							</h3>
							<p>
								Sé que esta parte de mi historia puede resultar controversial
								para muchos, porque existe la noción de que el Padre no escucha la
							...
							<p>
								...
								sincera de un pecador a un Padre justo y bondadoso, pidiendo
							...
							<p>
								...
								el Padre, así como su falta de mérito para encontrar perdón. En el
							...
							<p>
								Entiendo que si el Padre no me hubiera escuchado ni rescatado cuando
								...
								valentía cada obstáculo que se presenta. Si el Padre lo hizo una
							...
							<p>
								...
								nuestra relación el Padre. Todo cambio externo es un reflejo de
					...
					<section
						...
						<div className="space-y-6 text-lg text-slate-200">
							...
							<p>
								...
								vida a Cristo, mientras oraba un día, el Padre me habló con claridad
							...
							<p>
								...
								el sector ya se hablaba de lo que el Padre había hecho en nuestras
							...
							<p>
								...
								vida en el mundo. Ahora que estaba en el camino de el Padre, no
							...
							<p>
								...
								también una batalla espiritual. Proclamábamos el reino de el Padre
								con fervor.
							</p>

							<h3 className="text-xl font-bold text-yellow-100 mt-8 mb-4">
								El Padre no se ausenta en nuestra dificultad
							</h3>
							<p>
								Seguro conoces la historia de Sadrac, Mesac y Abed-Nego, tres
								jóvenes cuya fe en el Padre los llevó a enfrentar una prueba muy
							...
							<p>
								Este detalle es fundamental. A veces, el Padre no nos librará de las
								dificultades, sino que entrará en ellas con nosotros. En{" "}
								<strong className="text-yellow-300 font-bold">
									Isaías 43:2
								</strong>
								, el Padre nos promete:{" "}
								<span className="italic text-yellow-200">
								...
								En lugar de eliminar el sufrimiento, el Padre se une a nosotros en
								medio de él, ofreciéndonos Su presencia y fortaleza.
							</p>
							<p>
								Nos asegura que no estamos solos en nuestras luchas. Aunque
								enfrentemos desafíos y pruebas, la presencia de el Padre transforma
							...
							<p>
								...
								confían en que el Padre puede hacer lo mismo en la suya.
							</p>
							...
							<p>
								...
								el Padre y hablar de su grandeza. Aprendimos a reconocer su
							...
							<p>
								...
								insignificante y temeroso, pero el Padre lo usó para liberar a
								Israel de los madianitas. Jeremías era joven y sentía que no
								tenía la experiencia necesaria, pero el Padre lo llamó a ser un
								profeta poderoso.
							</p>
							<p>
							...
							<p>
								...
								escogidos. Los que realmente han sido seleccionados por el Padre y
								tienen el coraje de ser valientes, se visten con la armadura
								cristiana y salen al campo de batalla con la fe en el Padre como su
								guía.
							</p>
							<p>
								...
								difícil, el propósito de el Padre en nuestra vida es mucho más
							...
							<p>
								...
								ministerio que el Padre me ha confiado.
							</p>
							<p>
							...
							<div className="bg-yellow-900/20 p-6 rounded-lg my-8 border border-yellow-300/30">
								<p className="italic font-medium text-yellow-100 mb-4 text-center">
									...
									Puso luego en mi boca cántico nuevo, alabanza a nuestro Padre.
							...
							<p>
								...
								sobre el Padre que me salvó. ¡Lo gritaré en todos lados! ¡Cristo
								salva! ¡Cristo vive!
							</p>
						</div>
					</section>
					...
					<section
						...
						<div className="space-y-6 text-lg text-slate-200">
							...
							<p>
								...
								la bondad de el Padre, sino los que entienden que cada prueba es una
								...
								<span className="italic text-yellow-200">
									"El Padre da sus mejores batallas a sus mejores soldados"
								</span>
							...
							<p>
								...
								comunión el Padre. Podemos pensar que estamos en un lugar santo
							...
							<p>
								...
								comunión el Padre, dándonos la certeza de que Sus promesas se
								cumplirán en nuestras vidas. Sin embargo, si oramos sin
								reconocer quién es el Padre y sin la reverencia que merece, no
							...
							<p>
								...
								con la que Jesús lo hacía, nuestra comunicación el Padre se
							...
							<p>
								...
								cumpliendo la voluntad de el Padre en la tierra. Si Él, siendo el
								Hijo de el Padre, consideraba la oración una prioridad, cuánto más
								...
								autosuficiencia en lugar de buscar la dirección de el Padre.
							</p>
							<p>
								...
								oración debía ser en comunión íntima el Padre, en un diálogo
							...
							<p>
								...
								sino una relación genuina el Padre.
							</p>
							<p>
								El Padre no se fija tanto en el lugar físico donde estamos orando,
								...
								experiencia y la relación el Padre.
							</p>
							<p>
								...
								no es mecánica, es un espacio donde el Padre se revela, nos habla y
							...
							<p>
								Como hijos de el Padre, debemos aprender a aferrarnos a Su voluntad,
								...
								pero el Padre, que ve el panorama completo, tiene para nosotros lo
								mejor, incluso cuando no coincide con lo que inicialmente
								deseamos.
							</p>
							<p>
								Aferrarse a la voluntad de el Padre significa soltar nuestros
							...
							<p>
								...
								habló, Jesús, lo bautizara, pues sabía que era el Hijo de el Padre.
							...
							<p>
								...
								son grandes, pero el Padre tiene bendiciones aún mayores preparadas
								para nuestras vidas.
							</p>
							...
							<p>
								...
								en cualquier momento, el Padre nos moverá según su plan superior. No
							...
							<p>
								...
								repente descubres que la voluntad de el Padre es otra, simplemente
								...
								ideales sin consultar la voluntad de el Padre solo nos llevará por
								un "camino de muerte".
							</p>
							<p>
								Debemos dar lugar al Espíritu Santo para que ministre a nuestro
								espíritu sobre el propósito de el Padre para nosotros, moldeando
					...
					<section
						...
						<div className="space-y-6 text-lg text-slate-200">
							<p>
								...
								, el Padre dio una instrucción que, humanamente, no tenía sentido:
							...
							<p>
								...
								fe en la palabra de el Padre lo que les permitió conquistar la
							...
							<p>
								...
								que el Padre ya ha prometido? La fe es el puente que te llevará a un
								nivel más alto de intimidad el Padre, donde podrás alcanzar las
							...
							<p>
								...
								el Padre hará cosas mayores, grandes y poderosas en nuestra vida, si
								confiamos en Él.
							</p>
							<p>
								Recuerdo que un día, en una campaña evangelística, el Padre se
							...
							<p className="pl-4 border-l-2 border-yellow-300/50 text-yellow-200 italic">
								...
								envió, que es el Padre. ¿Tú crees que Él te sanará?
							</p>
							...
							<p className="pl-4 border-l-2 border-yellow-300/50 text-yellow-200 italic">
								...
								la madrugada con ataques. Si usted ora por mí, sé que el Padre me
								sanará.
							</p>
							<p>
								Le pregunté:{" "}
								<span className="italic text-yellow-200">
									—¿Tú crees que el Padre te sanará?
								</span>{" "}
								—y ella me respondió:{" "}
							...
							<p>
								...
								que el Padre la había sanado. Luego, la hija le dijo que se fuera a
							...
							<div className="bg-yellow-900/20 p-6 rounded-lg my-6 border border-yellow-300/30">
								<p className="italic font-medium text-yellow-100 mb-4">
									"Pero sin fe es imposible agradar a el Padre; porque es necesario
									que el que se acerca a el Padre crea que le hay, y que es
							...
							<p>
								...
								que cuando oramos a el Padre, aguardamos el milagro sin dudar,
								comprendiendo que la voluntad de el Padre para nuestras vidas es
								buena.
							</p>
							<p>
								Al orar, aunque no vea físicamente lo que pido, en el mundo
								espiritual sé que es una realidad. Si tomamos el versículo 6 y
								lo combinamos con el 1, notamos que el Padre se agrada de quien no
							...
							<p>
								...
								los recursos inagotables de el Padre. Es fundamental aclarar lo que
								significa la voluntad de el Padre, ya que quien ora con fe acepta su
								voluntad, entendiendo que es lo mejor para quien pide. La fe
								rompe cadenas, pero no intenta sobreponerse a los designios del
								Espíritu Santo.
							</p>
							<p>
								La fe no confunde la voluntad de el Padre con las emociones humanas.
								...
								convicción en el Padre y la seguridad de que Él te guía en todos tus
							...
							<p>
								Es fácil decir que tenemos fe en el Padre, que confiamos en su poder
							...
							<p>
								...
								sino que se mueve, confiando en que el Padre ya ha respondido.
							</p>
							<p>
								Es fácil decir que tienes fe, pero ¿cómo la demuestras? ¿Te
								estás moviendo en la dirección de lo que crees que el Padre hará en
								tu vida? La fe que agrada a el Padre es aquella que va más allá de
							...
							<p>
								...
								una vida guiada por la voluntad de el Padre. No es solo una creencia
								superficial, es una convicción que te lleva a actuar, a confiar
								plenamente en lo que el Padre hará, aunque aún no lo veas.
							</p>
							...
							<ul className="space-y-4">
								{[
									...
									{
										ref: "Romanos 10:17",
										text: "Así que la fe es por el oír, y el oír, por la palabra de el Padre."
									},
									{
										ref: "2 Corintios 5:7",
									...
									{
										ref: "Efesios 2:8",
										text: "Porque por gracia sois salvos por medio de la fe; y esto no de vosotros, pues es don de el Padre."
									},
									{
										ref: "Santiago 1:6",
					...
					<section
						...
						<div className="space-y-8 text-lg text-slate-200">
							<p>
								Cuando notas la ausencia de la voz de el Padre en tu vida, no es que
							...
							<p>
								A la mayoría no le gusta obedecer lo que el Padre pide, y por esta
								razón Él prefiere dejar de hablar, ya que sería en vano si no
								vamos a seguir Su voluntad. Si el Padre te habla constantemente y tú
								no obedeces, estarías pecando a cada momento, porque desobedecer
								es pecar. Por eso, en Su sabiduría y amor, el Padre prefiere dejar
							...
							<div>
								...
								<p className="mb-4">
									...
									porque eso podría hacerte perder las bendiciones que el Padre
									tiene para tu vida. Con frecuencia, asociamos nuestras
									emociones a nuestro propósito, lo que puede alejarnos del plan
									divino. El Padre amó tanto al mundo que entregó a Su único Hijo,
								...
								<p className="mb-4">
									...
									sintiéndote solo, angustiado o creyendo que el Padre te ha
									abandonado. Pero el Padre no busca a alguien que viva solo de
									sentimientos; Él está buscando guerreros que se levanten en
									medio de su llanto, en medio de su quebranto y batallas, y que
									digan:{" "}
									<span className="italic text-yellow-200">
										"Yo puedo, voy a pelear esta batalla porque el Padre me ha
										escogido para esto"
									</span>
									.
								</p>
								...
								<p className="mb-4">
									Así también sucede el Padre. Tal vez no solo te ha llamado,
								...
								<p>
									...
									aunque has pasado por mucho, has seguido adelante. El Padre te
							...
							<div>
								...
								<p className="mb-4">
									Es fundamental aprender a obedecer la voz de el Padre cuando nos
									...
									con ofrecer una disculpa cuando el Padre te llama a un perdón
								...
								<p className="mb-4">
									...
									con la confianza de que el Padre es y siempre será nuestro
									sustento.
								</p>
								<p className="mb-4">
							...
							<div>
								...
								<p className="mb-4">
									...
									Es fundamental pedirle a el Padre sabiduría para distinguir entre
								...
								<p className="mb-4">
									...
									cuándo seguir el propósito que el Padre ha puesto en tu corazón.
									Como dice{" "}
									<strong className="text-yellow-300 font-bold">
										Santiago 1:5
									</strong>
									: "Si a alguno de ustedes le falta sabiduría, pídala a el Padre, y
									Él se la dará, pues el Padre da a todos generosamente sin
					...
					<section
						...
						<div className="space-y-6 text-lg text-slate-200">
							...
							<p>
								...
								no podamos recibir lo que verdaderamente el Padre ha guardado para
								nosotros.
							</p>
							<p>
								A menudo pensamos que el Padre se ha olvidado de nosotros y por eso
								no recibimos lo que deseamos. Pero no es así; muchas veces
								estamos pidiendo lo que queremos, no lo que nos conviene. El Padre
					...
					<section
						...
						<div className="space-y-6 text-lg text-yellow-50">
							<p>
								...
								empoderas del poder de el Padre. En la relación el Padre hay poder.
								Existen dos tipos de relación: una el Padre y otra con tu
								prójimo. La relación el Padre debe ser prioritaria, y si tienes
								problemas en tu relación con el prójimo o el Padre, Él no oirá
								tu oración.
							</p>
							...
							<p>
								...
								la fuente de vida, que es el Padre, teniendo identidad y sabiendo
							...
							<p>
								Mientras más identidad tenemos, más el Padre nos usa. La identidad
							...
							<p>
								...
								necesario tener una vida de oración el Padre. En{" "}
								<strong className="text-white">Éxodo 32:32</strong>, cuando
								Moisés intercede por el pueblo que pecó contra el Padre haciendo un
								becerro de oro, la oración de intercesión de Moisés fue tan
								poderosa que el Padre la tomó en cuenta y cambió de parecer.
							</p>
							<p>
								...
								beneficios. Sacrificas para los demás, y a el Padre le agradan los
								sacrificios para Su gloria.
							</p>

							<h3 className="text-xl font-bold text-white mt-8 mb-4">
								Reconociendo la soberanía de el Padre
							</h3>
							<p>
								Para orar efectivamente, es imprescindible conocer nuestra
								posición y la de el Padre en la comunión que se establece entre el
								...
								. Esta debería ser la actitud de quien se acerca a el Padre en
								oración: reconocer Su absoluta deidad y superioridad.
							</p>
							<p>
								Nadie que busque a el Padre desde sus propios méritos, sin abdicar
								las coronas humanas frente al Redentor, podrá ser escuchado por
								el Rey de reyes y Señor de señores. El Padre no es un dios más; es
								...
								creer que somos iguales a el Padre.
							</p>
							...
							<p>
								...
								imposible conocer a el Padre sin la oración, ya que fue el medio
							...
							<p>
								...
								espíritu superior, al punto de que el Padre le revelaba los secretos
								de los tiempos. Además, debido a su constante comunión el Padre,
							...
							<p>
								...
								cuando queremos que el Padre nos use con poder o cuando tenemos
								necesidades.
							</p>
							<p className="font-medium text-center italic text-white/90 text-xl mt-8">
								"Seamos verdaderos hijos de el Padre. Comuniquemos a nuestro Padre
